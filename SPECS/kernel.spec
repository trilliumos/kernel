...
%define kernelpatch 10
# This is needed to do merge window version magic
%define patchlevel 18
# This allows pkg_release to have configurable %%{?dist} tag
%define specrelease 65%{?buildid}.%{?kernelpatch}%{?dist}
...
Patch2: https://cdn.kernel.org/pub/linux/kernel/v6.x/patch-%{tarfile_release}.%{kernelpatch}.tar.xz
...
#
%changelog
* Fri Feb 06 2026 Shaun Assam <sassam@fedoraproject.org> [6.18.0-65.154.8]
- Added 6.18.8 patch
- Removed 64K, 16K, rt, and zfcpdump configs
- Configured to build for aarch64 and x86_64 only
